  ...
  test("error when deleting record that does not exist", async () => {
    try {
      ...
      expect((e as Error).message).toMatch(
        /(Account With Id = f0161204-0f0a-ed11-82e6-0022483d2320 Does Not Exist)|(The requested record was not found or you do not have sufficient permissions to view it)|Entity 'account' With Id = f0161204-0f0a-ed11-82e6-0022483d2320 Does Not Exist/,
      );
    }
  }, 10000);
});
