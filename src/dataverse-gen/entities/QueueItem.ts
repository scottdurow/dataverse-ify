...
export interface QueueItem extends IEntity {
  ...
  */
  ...
  /*
  Live workstream LookupType Liveworkstream this queue item belongs to
  */
  msdyn_liveworkstreamid?: import("../../types/EntityReference").EntityReference | null;
  /*
   StringType
  */
  msdyn_liveworkstreamidname?: string | null;
  /*
